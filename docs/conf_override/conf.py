"""Temporary Sphinx config for building API docs (override).
This file is used only for local docs building and avoids editing the repo's
`docs/api/conf.py` which may be under version control.
"""
